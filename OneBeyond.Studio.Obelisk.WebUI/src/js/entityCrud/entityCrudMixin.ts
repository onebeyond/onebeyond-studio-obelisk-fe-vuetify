...
@Component
export default class EntityCrudMixin<TEntity extends Entity<T>, T, TGrid extends EntityGrid> extends Mixins(
    AlertMixin
) {
    ...
    async onEntityLoaded(): Promise<void> {
    ...
    async onEntityUpdated(): Promise<void> {
        ...
        await this.entityGrid.restoreCurrentPage();
        this.entity = new (this.provideEntityBuilder())();
        this.showEntity = false;
        this.isEditingEntityInline = false;
    }
